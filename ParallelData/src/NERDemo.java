...
public class NERDemo {
    ...
    public static void main(String[] args) throws IOException {
      ...
      String serializedClassifier = "D:/git/CiatationRec/ParallelData/classifiers/english.all.3class.distsim.crf.ser.gz";
      ...
      */
      if (args.length > 1) {
        ...
        String s1 = "PageRank algorithm was debveloped buy Larry Page[2], which is based on the random surfer model, similar to Markov chains";
